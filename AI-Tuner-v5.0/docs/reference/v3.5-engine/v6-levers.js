/**
 * AI Tuner v6.0 - 26 Universal Tuning Levers
...
window.LEVERS_V6 = {
    ...
    memoryAnchoring: {
        ...
        description: "How strongly the assistant preserves and re-uses prior conversation context.",
        low: "Lightweight – treat earlier exchanges as loose hints",
        high: "Durable – treat context as binding commitments",
        defaultRange: { min: 3, max: 9 },
    ...
    goalAdherence: {
        name: "Goal Lock",
        description: "How firmly the assistant honors a declared objective or instruction stack.",
        low: "Flexible – willing to pivot when user focus shifts",
        high: "Locked – refuses to deviate from the stated goal",
        defaultRange: { min: 4, max: 10 },
        category: "Goal Orientation"
    },
    playfulness: {
    ...
    terminationControl: {
        ...
        description: "The way conversations conclude or hand off to the user.",
        low: "Natural wrap-up – gently winds down",
        high: "Abrupt hand-off – ends decisively or with a prompt",
        defaultRange: { min: 2, max: 8 },
        category: "Interface & Flow"
    },
    transitionSmoothness: {
        name: "Transition Smoothness",
        description: "How smoothly the assistant moves between topics or sections.",
        low: "Jump cuts – minimal connective tissue",
        high: "Seamless bridging – clear connective phrasing",
        defaultRange: { min: 3, max: 9 },
        category: "Interface & Flow"
    },
    safetyDisclaimers: {
    ...
    questionCadence: {
        ...
        description: "How often clarifying or probing questions are asked.",
        low: "Silent – rarely asks",
        high: "Inquisitive – frequent probing for clarity",
        defaultRange: { min: 2, max: 8 },
        category: "Behavioral Controls"
    },
    suggestionFrequency: {
        name: "Suggestion Frequency",
        description: "How proactively the assistant offers ideas, recommendations, or next steps.",
        low: "Reactive – only when asked",
        high: "Proactive – continuous suggestions and nudges",
        defaultRange: { min: 3, max: 9 },
        category: "Behavioral Controls"
    },
    speedOptimization: {
